...
func ReadRidePositions(r *csv.Reader, d []*RidePosition, b chan []*RidePosition, wg *sync.WaitGroup) {
	go func() {
		var p1 *RidePosition
		firstIteration := true
...
func WriteFareToFile(rideFare chan *RideFare, wg *sync.WaitGroup) {
...
func ConvertLineToPosition(item1, item2, item3, item4 string) *RidePosition {
	...
	return NewRidePosition(id, x, y, ut)
}
